...
public class ChatServer extends NanoHTTPD {
    ...
    private static final String PASSWORD = "RandomPWD"; // Change this to your desired password
    ...
    static {
        ...
        quickCommands.put("pos", "/getpos");
        quickCommands.put("home", "/home");
        quickCommands.put("spawn", "/spawn");
        quickCommands.put("tpa", "/tpa");
    }
            ...
            if (Minecraft.getMinecraft().thePlayer != null && input.startsWith("/")) {
                ...
                for (ICommand cmd : ClientCommandHandler.instance.getCommands().values()) {
                    if (cmd.getCommandName().startsWith(commandName)) {
                        ...
                        if (completions != null) suggestions.addAll(completions);
                    }
                }
            }
        } catch (Exception e) {
            ...
            if (uri.equals("/login")) {
                if (session.getMethod() == Method.POST) {
                    ...
                    if (password != null && password.equals(PASSWORD)) {
                        Response response = newFixedLengthResponse(Response.Status.OK, "text/plain", "Login successful");
            ...
            if (uri.equals("/")) {
                ...
                if (session.getMethod() == Method.POST) {
                    ...
                    if (message != null && !message.trim().isEmpty()) {
                        ...
                        return newFixedLengthResponse(Response.Status.BAD_REQUEST, "text/plain", "Message cannot be empty");
                    }
                }
                ...
                if (session.getMethod() == Method.GET) {
                    return newFixedLengthResponse(Response.Status.OK, "application/json", gson.toJson(getCommandHistory()));
                }
            } else if (uri.equals("/quick-commands")) {
                if (session.getMethod() == Method.GET) {
                    return newFixedLengthResponse(Response.Status.OK, "application/json", gson.toJson(getQuickCommands()));
